...
if (!empty($action)) {
    ...
    // maintecas
    include_once('../function/numeroIntervention.php');
...
if ($action == "definirIntervention") {
    ...
    $objSetInter->setCompte($key_final);
